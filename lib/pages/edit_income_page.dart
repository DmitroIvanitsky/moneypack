...
class EditIncomeNotePage extends StatefulWidget {
  final Note note;
  ...
  @override
  _EditIncomeNotePageState createState() =>
      _EditIncomeNotePageState(this.note);
}

class _EditIncomeNotePageState extends State<EditIncomeNotePage> {
  Note editableNote;
  ...
  _EditIncomeNotePageState(this.editableNote);
  ...
  onCategoryTap(BuildContext context) {
    widget.navigatorService.navigateToEditIncomeCategoryPage(
      context: context,
            ...
            title: Row(
              ...
              children: [
                ...
                IconButton(
                    ...
                    onPressed: () async {
                      await widget.incomeService.editIncomeNote(widget.note, editableNote);
